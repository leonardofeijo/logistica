...
SELECT HPO.CODE, HPO.FORNSACHA, HPO.COMPONENT, DATE(HPO.PROVDATE) AS PROVDATE, HPO.PROVQTF, HPO.APRO, SUP.DN, SUP.DNDATE, SUP.PLACE, SUP.STATUS, SUP.DNQTF

FROM (SELECT DISTINCT PROV.AJARCD AS CODE, PROV.AJD5CD AS COMPONENT, 
	CONCAT('20', substr(PROV.AJAFDT, 2,2))||'-'||substr(PROV.AJAFDT, 4,2)||'-'||substr(PROV.AJAFDT, 6,2) AS PROVDATE, 
