-- FIXME: CONVERTER A TABELA TSA015X PARA TSA015
-- COLOCAR LEGENDA PARA IDENTIFICAÇAO DAS CORES
-- CORRIGIR LIMITE DE REC - C DE < 20 PARA < 2
-- APÓS ALTERAÇÕES, CRIAR VERSÃO MIN SEM QUEBRAS DE LINHAS E SEM COMENTÁRIOS
-- FORMATAR COR PARA IDENTIFICAR LINHAS COM ARTIGOS REPETIDOS
