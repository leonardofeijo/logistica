...
SELECT DISTINCT RUTURAS.USRLD3 AS ARTIGO, STORAGE.DE1713 AS UAP, RUTURAS.SA1512 AS FORNECEDOR, STOCK.SA1507 AS STKMAG, STOCK.SA1514 AS STKATE, STOCK.SA1509 AS COUVSTK, ('Y') AS RUT
...
SELECT DISTINCT PARTNO AS ARTIGO, STORAGE.DE1713 AS UAP, SUP_NAME AS FORNECEDOR, STK_WARE AS STKMAG, STK_WORK AS STKATE, STK_COVER AS COUVSTK, ('N') AS RUT
...
SELECT DISTINCT TJT004B.JTB404 AS ARTIGO, STORAGE.DE1713 AS UAP, STOCK.SA1512 AS FORNECEDOR, TJT004B.JTB411 AS SKTMAG, TJT004B.JTB412 AS STKATE, TJT004B.JTB423 AS COUVSTK, ('N') AS RUT
...
SELECT IC130M.LLPPN AS ARTIGO, STORAGE.DE1713 AS UAP,('C') AS RUT
FROM (SELECT IC130M.LLPPN, IC130M.LLSTLC, IC130M.LLBLT1, IC130M.LLBLT2, IC130M.LLBLT3, IC130M.LLBLT4 FROM AUTO.D805DATHPO.IC130M IC130M WHERE (((IC130M.LLBLT1)+(IC130M.LLBLT2)+(IC130M.LLBLT3)+(IC130M.LLBLT4))<>0) AND (IC130M.LLSTLC='REC') AND (IC130M.LLBLT2 > 0))
