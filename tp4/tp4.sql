...
SELECT DISTINCT SA1501 AS ARTIGO, STORAGE.DE1713 AS UAP, SA1512 AS FORNECEDOR, SA1507 AS STKMAG, SA1514 AS STKATE, SA1509 AS COUVSTK, ('STOCK LOW TSA') AS STATUS
FROM AUTO.D805DATHPO.TSA015 AS TSA015

LEFT JOIN AUTO.D805DATHPO.TDE017 STORAGE

ON TSA015.SA1501 = STORAGE.DE1730

WHERE TSA015.SA1505 = '03' AND TSA015.SA1509 < 2
...
-- TJT004B
SELECT DISTINCT TJT004B.JTB404 AS ARTIGO, STORAGE.DE1713 AS UAP, TJT004B.JTB425 AS FORNECEDOR, TJT004B.JTB411 AS SKTMAG, TJT004B.JTB412 AS STKATE, TJT004B.JTB423 AS COUVSTK, ('STOCK LOW TJT') AS STATUS
