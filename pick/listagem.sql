...
SELECT DISTINCT TPO001.PO0101 AS ARTIGO, FET001.COD, FET001.FORNECEDOR, FET001.PLACE, FET001.ETIQUETA, FET001.QTD 
FROM AUTO.D805DATHPO.TPO001 TPO001
INNER JOIN (SELECT DISTINCT LLPPN AS ARTIGOSTK, LLBLT1, LLBLT2, LLBLT3, LLBLT4 FROM AUTO.D805DATHPO.IC130M  WHERE LLSTLC = 'MP-KANB') STOCK
  ON STOCK.ARTIGOSTK = TPO001.PO0101
LEFT JOIN (SELECT ET0110 AS COD, ET0111 AS FORNECEDOR, ET0102 AS ARTIGO, ET0109 AS PLACE, ET0101 AS ETIQUETA, ET0103 AS QTD FROM AUTO.D805DATHPO.FET001 WHERE ET0105 = 'DIS' AND ET0104 = 'MP-KANB') FET001
